...
public interface ConditionToPredicateConverter<Entity> {

	Predicate convert(QueryInfoEntityContextRegistry entityContextRegistry,
			QueryInfoJPAContexts<?, ?> jpaContexts,
			QueryInfoJPAContext<Entity, ?> currentJpaContext,
